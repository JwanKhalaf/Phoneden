(function ($) {
  ...
  Webarch.prototype.initSideBarToggle = function() {
    var $this = this;
    $('[data-webarch="toggle-left-side"]').on('touchstart click',
      function(e) {
        e.preventDefault();
        $this.toggleLeftSideBar();
      });
    $('[data-webarch="toggle-right-side"]').on('touchstart click',
      function(e) {
        e.preventDefault();
  ...
  Webarch.prototype.initUtil = function() {
    ...
    $('[data-webarch-toggler="checkall"]').on('click',
      function() {
        var $el = $(this);
